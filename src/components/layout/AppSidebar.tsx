...
import { LayoutGrid, ShoppingCart, FileText as ReportIconOriginal, Package, BookUser, ReceiptText, ClipboardList, Warehouse, Layers, ListChecks, NotebookPen, ClipboardSignature, Activity, FileText } from 'lucide-react';
...
const allNavItems: NavItem[] = [
  ...
  { href: '/products', label: 'Products', icon: Package, roles: ['SalesCoordinator', 'Admin'] },
  { href: '/products/stock-management', label: 'Product Stock', icon: Layers, roles: ['SalesCoordinator', 'Admin'] },
  { href: '/store', label: 'Store Items', icon: Warehouse, roles: ['Store', 'Admin'] },
